...
def store_chroma(docs, embedding, persist_directory="VectorStore2"):
    """
    讲文档向量化，存入向量数据库
    :param docs:
    :param embedding:
...
if not os.path.exists('VectorStore2'):
    ...
    db = Chroma(persist_directory='VectorStore2', embedding_function=embeddings)
...
# llm = ChatGLM()
# llm.load_model(r"/Users/yuansheng/ai/models/chatglm3-6b")
# 创建qa
